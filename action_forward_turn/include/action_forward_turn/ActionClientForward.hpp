...
#ifndef ACTION_FORWARD_TURN__ACTIONCLIENTFORWARD_HPP_
#define ACTION_FORWARD_TURN__ACTIONCLIENTFORWARD_HPP_
...
public:
  ...
  ActionClientForward();
  void send_advance_request(GenerateInformation::Goal goal);
  float distance;
...
#endif  // ACTION_FORWARD_TURN__ACTIONCLIENTFORWARD_HPP_